...
const Footer = () => (
    <footer className="bg-medium border-t border-subtle py-12">
        <div className="container mx-auto px-6 text-center text-main">
            <div className="flex justify-center space-x-6 mb-6">
                <a href="#" className="text-main hover:text-accent transition-all-smooth" aria-label="LinkedIn">
                    <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
