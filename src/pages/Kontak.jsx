             ...
             <div className="max-w-md mx-auto mt-36">
                <div className="bg-medium p-8 rounded-xl border border-subtle">
                    ...
                    <div className="flex justify-center space-x-8">
                        <a href="#" className="text-main hover:text-accent transition-all-smooth" aria-label="LinkedIn">
                        ...
                        <a href="#" className="text-main hover:text-accent transition-all-smooth" aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
                        ...
                        <a href="#" className="text-main hover:text-accent transition-all-smooth" aria-label="GitHub">
                            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
